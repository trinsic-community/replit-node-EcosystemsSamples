...
// file: okapi/proofs/v1/proofs.proto
...
export class CreateProofRequest extends jspb.Message {
  ...
  setKey(value?: okapi_keys_v1_keys_pb.JsonWebKey): CreateProofRequest;
  getSuite(): LdSuite;
  ...
  static toObject(
    ...
    msg: CreateProofRequest
  ): CreateProofRequest.AsObject;
...
export class CreateProofResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CreateProofResponse
  ): CreateProofResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class VerifyProofResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: VerifyProofResponse
  ): VerifyProofResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
